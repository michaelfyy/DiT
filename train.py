...
"""
A minimal training script for DiT on a single GPU (no PyTorch DDP).
"""
import torch
...
def cleanup():
    """
    End training (no-op for single GPU).
    """
    return
...
def main(args):
    ...
    print(f"Starting single-GPU training, seed={seed}, device={device}.")
