...
"""
Samples a large number of images from a pre-trained DiT model on a single GPU.
Subsequently saves a .npz file that can be used to compute FID and other
evaluation metrics via the ADM repo: https://github.com/openai/guided-diffusion/tree/main/evaluations

This is a single-GPU version of sample_ddp.py (DDP removed).
...
def main(args):
    ...
    print(f"Starting single-GPU sampling, seed={args.global_seed}.")
    ...
    # Convert samples to .npz for ADM FID/metrics:
